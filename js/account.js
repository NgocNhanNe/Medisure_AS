...
async function changepass(){
    ...
    if(oldpass===""){
        alert("Current Passowrd is empty, please enter data!")
        return
    }
    if(newpass===""){
        alert("New Passowrd is empty, please enter data!")
        return
    }
    if(repass===""){
        alert("Confirm Passowrd is empty, please enter data!")
        return
    }
    if(newpass.length < 6){
        alert("Password must be more than 5 characters!")
    ...
    if(response.status < 300){
        swal({
            title: "Notification", 
            text: "Change New Password successfully!", 
            type: "success"
          },
        function(){ 
            logout()
        ...
        swal({
            title: "Notification", 
            text: "Change New Password is unsuccessful!", 
            type: "error"
          },
        function(){ 
            window.location.reload();
